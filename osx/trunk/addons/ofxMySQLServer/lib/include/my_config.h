...
#define IGNORE_SIGHUP_SIGQUIT 1
#define _P1003_1B_VISIBLE 1
#define DONT_DECLARE_CXA_PURE_VIRTUAL 1
...
#define PACKAGE_STRING "MySQL Server 5.5.5-m3"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.5.5-m3"
#define VERSION "5.5.5-m3"
